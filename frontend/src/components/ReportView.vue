<template>
  <div class="content-block border-2 border-black">
    <!-- Заголовок отчета -->
    <div class="border-b-2 border-black p-6 bg-white">
    ...
    <div class="p-8 bg-white">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
        <div class="border-2 border-black p-5 bg-white">
          <div class="mb-3">
        ...
        <div class="border-2 border-black p-6 bg-white">
          ...
          <ul class="space-y-3">
            <li
              ...
              :key="index"
              class="flex items-start border-2 border-black p-4 bg-white"
            >
              <span class="inline-block w-6 h-6 border-2 border-black bg-black text-white text-xs font-bold flex items-center justify-center mr-3 flex-shrink-0 mt-0.5">{{ index + 1 }}</span>
          ...
          <div v-if="aiIndicators.software_detected.length > 0" class="mb-6">
            ...
            <div class="flex flex-wrap gap-2">
              <span
                ...
                :key="software"
                class="px-4 py-2 border-2 border-black bg-black text-white text-xs font-medium"
              >
                {{ software }}
              </span>
            </div>
          ...
          <div v-if="aiIndicators.anomalies.length > 0">
            ...
            <div class="space-y-2">
              <div
                ...
                :key="index"
                class="border-2 border-black p-3 bg-white flex items-start"
              >
      ...
      <div class="mb-10">
        <button
          ...
          class="w-full border-2 border-black p-4 bg-white hover:bg-gray-50 transition-colors flex items-center justify-between text-left"
        >
        ...
        <div
          v-show="showMetadata"
          class="border-x-2 border-b-2 border-black p-6 bg-white"
        >
      ...
      <!-- Кнопки экспорта -->
      <div class="flex flex-wrap gap-4 pt-6 border-t-2 border-black">
        <button
        ...
        <button
          ...
          class="px-6 py-3 border-2 border-black bg-white text-black text-sm font-medium hover:bg-gray-50 transition-colors"
        >
          ЭКСПОРТ JSON
        </button>
      </div>
